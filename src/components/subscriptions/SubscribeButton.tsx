  ...
  if (isSubscribed) {
    return (
      <div className="flex items-center gap-2">
        <span className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium bg-linear-to-r from-blue-500 to-blue-500 text-white">
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium bg-linear-to-r from-blue-500 to-blue-500 text-white shadow-lg shadow-blue-500/25 hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        title={
          !session
            ? "ログインが必要です"
            : isOwnProfile
