          ...
          {chargesEnabled ? (
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 rounded-xl text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-blue-500 shadow-lg shadow-purple-500/25 hover:shadow-xl disabled:opacity-50 transition-all duration-200"
              >
                {loading ? "処理中..." : "設定を続ける"}
              </button>
            </div>
