...
export default async function AdminDashboardPage() {
  const [userCount, workCount, commentCount, likeCount, viewStats, subStats, activeSubCount, premiumStats, activePremiumCount, recentWorks, recentComments, recentSubs, recentPremium, subSetting, premiumSetting] =
    await Promise.all([
